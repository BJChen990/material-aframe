...
export default class BaseSingleLineListItem extends React.Component {
    ...
    _getTextPart() {
        ...
        return (
            <a-entity
                geometry={`primitive: plane; width: ${textWidth}; height: ${listHeight};`}
                araisedcanvas={`width: ${textWidth * 360}; height: ${listHeight * 360};`}
