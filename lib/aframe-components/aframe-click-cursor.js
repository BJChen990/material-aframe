...
AFRAME.registerComponent('acursor', {
    ...
    init: function init() {
        ...
        cursorEl.addEventListener('raycaster-intersection-cleared', this.onIntersectionCleared.bind(this));
    },
    ...
    * Handle intersection.
    */
    onIntersection: function onIntersection(evt) {

        /** BJ Insert START **/
        this.eventInfo = evt.detail;
        /** BJ Insert END **/
    ...
    */
    onIntersectionCleared: function onIntersectionCleared(evt) {
    ...
    */
    twoWayEmit: function twoWayEmit(evtName) {
        ...
        intersectedEl.emit(evtName, { cursorEl: this.el, intersectInfo: this.eventInfo });
        /** BJ Insert END **/
    }
});